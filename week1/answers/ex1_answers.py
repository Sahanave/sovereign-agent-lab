...
The models were robust against the distractors. Holyrood seemed like the option most likely to mislead the model, but in the end the model still remained robust.
"""
...
CORE_LESSON = """
Context formatting matters most when the input is large, unstructured, and potentially confusing, because the model may otherwise miss or overlook important facts. 
The main lesson I learned is that even small details in the context can affect the outcome. It is similar to the difference between skimming and carefully reasoning through what is written.
"""
